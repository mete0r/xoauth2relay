...
@setup_dir
def get_version():
    from mete0r_xoauth2relay import __version__
    return __version__
...
setup_info = {
    ...
    'version': get_version(),
    'description': 'SMTP XOAUTH2 Relay',
    ...
    'packages': [
        'mete0r_xoauth2relay',
        'mete0r_xoauth2relay.recipe',
        'mete0r_xoauth2relay.tests',
        'mete0r_xoauth2relay.tests.fixtures',
        'mete0r_xoauth2relay.tests.layers',
    ],
    ...
    'entry_points': {
        'console_scripts': [
            'xoauth2relay = mete0r_xoauth2relay.cli:main',
        ],
        'zc.buildout': [
            'default = mete0r_xoauth2relay.recipe:Recipe',
        ],
        'zc.buildout.uninstall': [
            'default = mete0r_xoauth2relay.recipe:uninstall',
        ],
        'paste.app_factory': [
            'main = mete0r_xoauth2relay.wsgi:app_factory',
        ],
    },
    'classifiers': [
